/*
Package jobprocessor contains logic to create pool of goroutines to run any number of
tasks parallely.This helps in submitting job by passing struct objects.
...
It creates the workerpool using the passed jobContext.A JobContext mostly contains:
	...
	WorkRoutineCount- WorkRoutineCount is count of workers the consumer want in workerpool
